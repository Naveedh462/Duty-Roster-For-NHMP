...
public class LoginOfficerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_Button = findViewById(R.id.officer_login);
        editTextEmail = findViewById(R.id.officer_email);
        editTextPassword = findViewById(R.id.officer_password);
    ...
    private void forgetPassword() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(LoginOfficerActivity.this, pairs);
